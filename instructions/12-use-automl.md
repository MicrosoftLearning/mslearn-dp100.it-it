---
lab:
  title: Usare Machine Learning automatizzato dall'SDK
ms.openlocfilehash: 9fe1941effaf6672a2e0bd9ab663042f73a660f5
ms.sourcegitcommit: 18f734eeb1031a9cb69c3b294632efd2e69324ac
ms.translationtype: HT
ms.contentlocale: it-IT
ms.lasthandoff: 11/17/2021
ms.locfileid: "132832631"
---
# <a name="use-automated-machine-learning-from-the-sdk"></a>Usare Machine Learning automatizzato dall'SDK
...
## <a name="use-the-sdk-to-run-an-automated-machine-learning-experiment"></a>Usare l'SDK per eseguire un esperimento di Machine Learning automatizzato

In questo esercizio il codice per eseguire un esperimento di Machine Learning automatizzato viene fornito in un notebook.

1. Nella home page di Jupyter passare alla cartella **/users/*nome-utente*/mslearn-dp100** in cui è stato clonato il repository del notebook e aprire il notebook **Use Automated Machine Learning**.
