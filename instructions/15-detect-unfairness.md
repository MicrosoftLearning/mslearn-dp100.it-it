---
lab:
  title: Rilevare e mitigare l'iniquità
ms.openlocfilehash: 5e04b41a984fa65b09d3d0a7f249641916438415
ms.sourcegitcommit: 18f734eeb1031a9cb69c3b294632efd2e69324ac
ms.translationtype: HT
ms.contentlocale: it-IT
ms.lasthandoff: 11/17/2021
ms.locfileid: "132832619"
---
# <a name="detect-and-mitigate-unfairness"></a>Rilevare e mitigare l'iniquità

I modelli di Machine Learning possono spesso contenere una distorsione accidentale che causa iniquità. Un modello di Machine Learning che stima se un paziente deve essere sottoposto al test del diabete, ad esempio, può essere più accurato per alcune fasce di età rispetto ad altre, con il risultato che una parte del gruppo di pazienti può essere privata di controlli sanitari preventivi appropriati o, al contrario, sottoposta a test clinici non necessari.
...
## <a name="use-fairlearn-and-azure-machine-learning-to-detect-unfairness"></a>Usare Fairlearn e Azure Machine Learning per rilevare l'iniquità

In questo esercizio il codice per valutare l'equità dei modelli viene fornito in un notebook.

1. Nella home page di Jupyter passare alla cartella **/users/*nome-utente*/mslearn-dp100** in cui è stato clonato il repository del notebook e aprire il notebook **Detect Unfairness**.
