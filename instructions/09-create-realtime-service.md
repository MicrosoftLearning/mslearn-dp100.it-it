---
lab:
  title: Creare un servizio di inferenza in tempo reale
ms.openlocfilehash: ff6fbdd4e17fbb3fdf1c22544d0eefa08dde4959
ms.sourcegitcommit: 18f734eeb1031a9cb69c3b294632efd2e69324ac
ms.translationtype: HT
ms.contentlocale: it-IT
ms.lasthandoff: 11/17/2021
ms.locfileid: "132832628"
---
# <a name="create-a-real-time-inference-service"></a>Creare un servizio di inferenza in tempo reale

È inutile eseguire il training e la registrazione di modelli di Machine Learning se non si prevede di renderli disponibili per poter essere usati dalle applicazioni. In questo esercizio si distribuirà un modello come servizio Web per l'inferenza in tempo reale.
...
## <a name="create-a-real-time-inferencing-service"></a>Creare un servizio di inferenza in tempo reale

In questo esercizio il codice per distribuire un modello come un servizio di inferenza in tempo reale viene fornito in un notebook.

1. Nella home page di Jupyter passare alla cartella **/users/*nome-utente*/mslearn-dp100** in cui è stato clonato il repository del notebook e aprire il notebook **Create a Real-time Inferencing Service**.
